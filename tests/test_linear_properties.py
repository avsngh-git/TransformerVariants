"""Property-based tests for LinearAttention module.
...
from src.models.linear_attention import LinearAttention, feature_map
...
def test_numerical_stability_finite_outputs(B, T, seed):
    """LinearAttention produces finite outputs for inputs in [-10, 10].
